...
export default class Collider extends Entity {
    constructor(x, y, opts = {}) {
        ...
        this.collider = new Collider.crash.Polygon(
            new Collider.crash.V(sprite.x, sprite.y), Collider.getSpriteCornersPoints(sprite), true, { sprite, entity: this }
        )
    ...
    static getSpriteCornersPoints(sprite) {
        const offset = new Collider.crash.V(sprite.anchor.x * sprite.width, sprite.anchor.y * sprite.height)
        return [
